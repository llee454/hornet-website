...
The Video Library module defines a Search Source which encompasses all of the videos within the Video Library database. This source can be used by the Search module to return videos in response to search queries.
...
The Video Library organizes videos into libraries and collections. These are represented by the `video_library_Video`, `video_library_Collection`, and `video_library_Library` classes.
