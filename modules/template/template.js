...
QUnit.test ('template_TemplateStore: Function added before template', function (assert) {
  assert.expect (2);
  var done = assert.async ();
  ...
  assert.ok (templateFunction2HasRun, '123');
  assert.notOk (templateFunction3HasRun, '456')
  console.log(templateFunction2);
  console.log(templateFunction3);
  done ();
})
*/
